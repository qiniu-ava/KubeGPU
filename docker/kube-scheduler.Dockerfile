...
RUN CGO_ENABLED=1 go build --buildmode=plugin -o /gpuschedulerplugin.so /go/src/github.com/Microsoft/KubeGPU/plugins/gpuschedulerplugin/plugin/gpuscheduler.go
